...
import { downCaret } from "@planningcenter/icons/paths/general"
import ColorSchemeWrapper from "../utils/color-scheme-wrapper"

<Meta title="Legacy/Dropdowns" />
    ...
    >
      <Menu>
        <MenuButton className="compact-btn secondary-btn btn">
          Open menu
          <span
            data-reach-menu-button-toggle-icon
            style={{ marginLeft: "4px", position: "relative", top: 1 }}
          >
            <Icon
              title="Down caret"
